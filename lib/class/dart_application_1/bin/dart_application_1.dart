...
class User {
  ...
  Map<String, String> toJson() {
    return {
      ...
      'datenaisseuser': dateNaissance.toIso8601String(),
      'datecreateuser': dateCreation.toIso8601String(),
      'etatuser': etat ? "1" : "0",
      'gcuuser': gcu ?"1" : "0",
      'villeuser': ville,
      'paysuser': pays,
  ...
  Future<void> addUserDb(User user) async {
    final result = await http.post(
      Uri.parse(Constants.urlApi+"testFile.php"),
      body: user.toJson()
...
void main(List<String> args) {
 User kev = User(id: 333, nom: "nom", prenom: "prenom", password: "password", email: "email", reference: "reference", dateNaissance: DateTime.now(), dateCreation: DateTime.now(), etat: true, gcu: false, ville: "ville", pays: "pays", adresse: "adresse", telephone: "telephone", photoProfil: "photoProfil", photoBack: "photoBack", titreRole: "titreRole", about: "about");
 kev.addUserDb(kev); 
